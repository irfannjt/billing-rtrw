...
function isBuiltinAcsEnabled() {
  const val = getSetting('use_builtin_acs');
            ...
            for (const server of servers) {
                try {
                    ...
                    try {
                        ...
                        const isNetworkError = !e.response || e.code === 'ECONNABORTED' || e.code === 'ENOTFOUND' || e.code === 'ECONNREFUSED' || e.message.includes('timeout');
                        if (isNetworkError) {
                            throw e;
                        }
