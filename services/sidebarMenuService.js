...
const MENU_DEFINITIONS = [
  ...
  { key: 'mikrotik', section: 'router', href: '/admin/routers', icon: 'bi bi-router', labelKey: 'admin.nav.mikrotik', labelDefault: 'Router / NAS', roles: ['admin', 'cashier'], bottomNav: true, activePages: ['mikrotik', 'routers'] },
  ...
  { key: 'billing_dashboard', section: 'billing', href: '/admin/billing-dashboard', icon: 'bi bi-pie-chart-fill', labelKey: 'admin.nav.billing_dashboard', labelDefault: 'Dashboard Tagihan', roles: ['admin', 'cashier'], activePages: ['billing_dashboard'] },
  ...
  { key: 'vpn_health', section: 'router', href: '/admin/vpn-health', icon: 'bi bi-shield-network', labelKey: 'admin.nav.vpn_health', labelDefault: 'VPN Server', roles: ['admin'], activePages: ['vpn_health'] },
...
const DEFAULT_MENU_STATES = {
  ...
  billing_dashboard: STATE_VISIBLE,
...
const SECTION_DEFINITIONS = [
  ...
  { key: 'router', labelKey: 'admin.section.router', labelDefault: 'ROUTER' },
